          ...
          <SidebarHeader className="h-16 justify-center border-b border-white/10">
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              <button
                ...
                className="h-8 w-8 flex items-center justify-center hover:bg-white/8 rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 shrink-0"
              ...
              {visibleMenuItems.map(item => {
                ...
                return (
                  <SidebarMenuItem key={item.path}>
                    ...
                    >
                      <item.icon
                        className={`h-4 w-4 ${isActive ? "text-emerald-300" : ""}`}
                      />
          ...
          <SidebarFooter className="p-3 bg-transparent border-t border-white/10">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-3 rounded-lg px-1 py-1 hover:bg-white/8 transition-colors w-full text-left group-data-[collapsible=icon]:justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500">
